...
# シリアルポートとボーレートの設定
PORT = '/dev/cu.wchusbserial537A0129701'  # M5Stackが接続されているポートを指定
BAUDRATE = 115200
    ...
    while True:
        ...
        if not command_queue.empty():
            ...
            if user_input.startswith("input "):
                # ファイル名を抽出
                compile_file_name = user_input.split(" ", 1)[1]
                filename = "./bytecode_dist/temp.txt"
                subprocess.run(["./analysis.out",compile_file_name,"table/2025_01_15_table_4.txt",filename])
